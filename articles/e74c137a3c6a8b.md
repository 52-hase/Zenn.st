...
・`Xのロゴ`に「`でライブをシェアする`」という文言をつけ加え、`Xでライブをシェアする`
...
[![Image from Gyazo](https://i.gyazo.com/beaa29026b8a3f6594d1cfb0fb30423a.png)](https://gyazo.com/beaa29026b8a3f6594d1cfb0fb30423a)