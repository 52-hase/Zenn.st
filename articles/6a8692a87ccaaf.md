...
README作成による要件・仕様の整理、画面遷移図やER図による設計、issueベースでのタスク管理を通じた開発、そしてMVPとしてのリリースという流れを学びました。これらの学びを生かし、音楽ライブ・フェスの感想をリアルタイムで共有できるチャットアプリ「LiveFes」を開発し、要件定義から設計、実装、デプロイまでを一貫して経験いたしました。
