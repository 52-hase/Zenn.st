...
2023年12月に日本郵便を退社後、同月にプログラミングスクールのRUNTEQに入学し、現在までRuby on Railsを中心とした学習を行なってきた。


私の強みは「継続力」です。前職の日本郵便では、半年に一度のペースで業務改正があり、その都度内容を局員で洗い出し、イレギュラーな対応にも備える学習を継続してきました。この取り組みを通じて、業務効率化の提案を行い、実際に手続きの見直しやチームでの主体的な行動を促進した結果、連絡会内（約50局)の物販営業成績で1位を達成することができました。

この継続的に学び改善し続ける姿勢は、プログラミング学習においても発揮しています。毎日Notionに学習内容やエラー解消の過程をアウトプットし、特に苦戦した内容はZennで記事として発信することで理解を深めてきました。また、疑問に感じたことをその場で無闇に深追いせず、実装後にまとめて調べる工夫をすることで、限られた時間の中でも学習と実装のバランスを保っています。

入社後も、この継続力を活かして日々のキャッチアップを怠らず、技術力を高めながらチームに貢献できるエンジニアを目指します。